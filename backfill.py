...
# Configuración
ARCHIVO_LISTA = "all_forms.txt" # El archivo con la lista de nombres
BASE_URL = "https://storage.googleapis.com/sicoescan/" # URL base de tu bucket
...
def run_backfill():
    ...
    for line in lines:
        ...
        # Si tu lista ya tiene "forms/archivo.html", la url queda bien.
        # Si tu lista solo tiene "archivo.html", ajusta la URL abajo.
        if file_name.startswith("forms/"):
            url = f"{BASE_URL}{file_name}"
        else:
            url = f"{BASE_URL}forms/{file_name}"
