...
def process_200(html_content, file_name, db):
    print(f"--- Procesando Formulario 200: {file_name} ---")
    ...
    try:
        ...
        insert_convocatoria(
            ...
            forms="FORM200"      # Se añadirá al array de forms
        )
    ...
    print(f"✅ Formulario 200 procesado: {convocatoria_data.get('cuce')}")